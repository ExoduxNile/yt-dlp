...
class KnownDRMIE(UnsupportedInfoExtractor):
    ...
    * Multiple users have asked about this site on github/discord
    ...
    _TESTS = [{
        ...
        # https://github.com/exoduxnile/yt-dlp/issues/4122
        'url': 'https://www.tvnz.co.nz/shows/ice-airport-alaska/episodes/s1-e1',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/1922
        'url': 'https://www.oneplus.ch/play/1008188',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/1140
        ...
        # https://github.com/exoduxnile/yt-dlp/issues/3544
        'url': 'https://www.philo.com/player/player/vod/Vk9EOjYwODU0ODg5OTY0ODY0OTQ5NA',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/3533
        ...
        # https://github.com/exoduxnile/yt-dlp/issues/2934
        'url': 'https://www.aha.video/player/movie/lucky-man',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/2743
        'url': 'https://mubi.com/films/the-night-doctor',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/3287
        'url': 'https://www.vootkids.com/movies/chhota-bheem-the-rise-of-kirmada/764459',
        'only_matching': True,
    }, {
        # https://github.com/exoduxnile/yt-dlp/issues/2744
